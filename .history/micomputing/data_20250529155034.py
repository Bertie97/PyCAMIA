...
class DataObject:
    ...
    @property
    def shape(self): return DataObject(self, prop=(self.property + ['shape']) if self.property else ['shape'])
    
    @property
    def affine(self): return DataObject(self, prop=(self.property + ['affine']) if self.property else ['affine'])
    
    @property
    def header(self): return DataObject(self, prop=(self.property + ['header']) if self.property else ['header'])
    
    @property
    def orient(self): return DataObject(self, prop=(self.property + ['orient']) if self.property else ['orient'])
    
    dtypes = ['long', 'float']
    
    @property
    def long(self): return DataObject(self, prop=(self.property + ['long']) if self.property else ['long'])
    
    @property
    def float(self): return DataObject(self, prop=(self.property + ['float']) if self.property else ['float'])
