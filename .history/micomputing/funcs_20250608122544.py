...
class registration:
    ...
    def align(self, trans_cls: Transformation, down_sample=6, max_iter=200, step_length=1e-3, loss='NMI', bend_coeff=1e-3, FFD_spacing=20):
        ...
        pre_align = self.trans.between_spaces(source_aff, target_aff)
        ...
        if trans_cls in [Affine, Rigid, PolyAffine, LocallyAffine]:
            specific_params['trans_std'] = 1 / max(down_sample)
        ...
        trans.source = trans.source / source_scalemat
        trans.target = trans.target / target_scalemat
