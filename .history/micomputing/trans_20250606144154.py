...
class FreeFormDeformation(Transformation):
    ...
    def __init__(self, offsets, spacing=1, origin=0, ffdaffine=None, **kwargs):
        ...
        super().__init__(offsets, spacing=spacing, origin=origin, ffdaffine=ffdaffine, **kwargs)
    ...
    def __call_physical_space__(self, phyX):
        n_dim = self.n_dim
        if self.ffdaffine is not None: prev_affine = self.ffdaffine
        elif self.backward:
