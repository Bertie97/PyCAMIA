...
class registration:
    ...
    def align(self, trans_cls: Transformation, down_sample=6, max_iter=200, step_length=1e-3, loss='NMI', FFD_spacing=20, domain='physical'):
        source = self.source
        target = self.target
        ...
        for i in range(max_iter):
            raw_trans = trans_cls(*params, domain=domain, use_implementation='image-space', source=source_aff, target=target_aff)
