...
class AtParamsTests(unittest.TestCase):
    ...
    def test_leading_to_new_typehint(self):
        ...
        print((func.__code__.co_flags & 0x08))
        print((func.__code__.co_flags & 0x04))
        print(bool(func.__code__.co_flags & 0x02))
        print(bool(func.__code__.co_flags & 0x01))
        ...
        def func_out(*args, **kwargs):
            ...
            return ret_value
        print(func_out(10., "abcd", c=max, d='', this=3, that=5))
        print(func_out(10., "abcd", max, 4, 4, 5, this=3, that=5))
