...
class Optimization:
    ...
    def train(self, max_epoch=10, n_epoch_valid=1, n_batch=4):
        ...
        Args:
            max_epoch (int): The number of times we scan the dataset, i.e. the number of epochs. Default: `10`
            n_epoch_valid (int): Validate every n_epoch_valid epochs. Default: `1`
            n_batch (int): Batch size for training and validation. Default: `4`
        """
...
def test(dataset, n_batch=4, test_info=None):
    ...
    Args:
        dataset (Dataset): The dataset structure.
        n_batch (int): Batch size for testing. Default: `4`
